...
const DEFAULT_LIMITS: Record<GroupOperation, GroupOpLimit> = {
 ...
 */
export function classifyGroupOpError(err: unknown): GroupOpErrorCode | null {
...
export function extractPrivacyBlock(result: unknown[]): PrivacyBlockResult {
...
export class GroupOperationGuard {
  private readonly limits: Record<GroupOperation, GroupOpLimit>;
  ...
  getStats(): GroupOperationGuardStats {
    const stats: GroupOperationGuardStats = {};
