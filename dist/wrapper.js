...
import { GroupOperationGuard } from './groupOperationGuard.js';
import { LegitimacySignalInjector } from './legitimacySignalInjector.js';
/**
...
export function wrapSocket(sock, config, warmUpState, wrapOptions) {
    ...
    if (options.legitimacySignals !== false) {
        legitimacyInjector = new LegitimacySignalInjector(typeof options.legitimacySignals === 'object' ? options.legitimacySignals : {});
    }
 ...
 */
export function wrapSocketWithFingerprint(makeWASocket, socketConfig, wrapOptions) {
