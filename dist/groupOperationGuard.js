...
export function classifyGroupOpError(err) {
    ...
    if (msg.includes('rate-overlimit') || msg.includes('429'))
        return GROUP_OP_ERRORS.RATE_OVERLIMIT;
    if (msg.includes('locked'))
        return GROUP_OP_ERRORS.GROUP_LOCKED;
    if (msg.includes('gone'))
        return GROUP_OP_ERRORS.INVITE_EXPIRED;
    return null;
}
export function extractPrivacyBlock(result) {
